...
class Trainer:
    ...
    def __init__(self, config=None):
        ...
        self.dtype = self.config.get('dtype', 'bfloat16' if torch.cuda.is_available() and torch.cuda.is_bf16_supported() else 'float16')
    ...
    def init_model(self):
        ...
        # optimizer
        self.optimizer = self.model.configure_optimizers(self.weight_decay, self.learning_rate, 
